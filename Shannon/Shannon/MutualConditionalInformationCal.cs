...
{
    public double MutualConditionaInformation(string seq1, string seq2, string seq3)
    {
       ...
       // result = Truncate(HXZ) + Truncate(HYZ) - Truncate(HXYZ) - Truncate(HZ);
        ...
        resultTest= Math.Truncate(resultTest * 100)/ 100;
        return Truncate(resultTest);
    }
    ...
    public double MutualConditionaInformationMoreDetailed(string seq1, string seq2, string seq3)
    {
        var alphabetX = seq1.Distinct().ToList();
        var alphabetY = seq2.Distinct().ToList();
        var alphabetZ = seq3.Distinct().ToList();
